...
export default function DashboardOverview() {
  ...
  const stats = [
    { title: 'Total Reviews Generated', value: '142', icon: <Star size={24} color="#fbbf24" />, change: '+12%' },
    { title: 'Profile Views', value: '891', icon: <Activity size={24} color="#6366f1" />, change: '+5%' },
    { title: 'QR Scans', value: '356', icon: <Users size={24} color="#a855f7" />, change: '+18%' },
    { title: 'Average Rating', value: '4.8', icon: <TrendingUp size={24} color="#10b981" />, change: '+0.2' },
  ];
