    ...
    const fetchVendorData = async () => {
      try {
        ...
        if (data.success && data.vendor) {
          ...
          setCustomerUrl(`${window.location.origin}/review/${data.vendor.vendorId}`);
        }
      } catch (err) {
        console.error(err);
          ...
          <div className="form-group">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div 
                ...
                style={{ 
                  border: qrTemplate === 'standard' ? '2px solid var(--primary-color)' : '2px solid rgba(255,255,255,0.1)',
                  padding: '1rem',
                  borderRadius: '0.5rem',
                  cursor: 'pointer',
                  textAlign: 'center',
                  background: qrTemplate === 'standard' ? 'rgba(99,102,241,0.1)' : 'transparent',
                  transition: 'all 0.2s'
                }}
              >
                Standard
              ...
              <div 
                ...
                style={{ 
                  border: qrTemplate === 'google-review' ? '2px solid var(--primary-color)' : '2px solid rgba(255,255,255,0.1)',
                  padding: '1rem',
                  borderRadius: '0.5rem',
                  cursor: 'pointer',
                  textAlign: 'center',
                  background: qrTemplate === 'google-review' ? 'rgba(99,102,241,0.1)' : 'transparent',
                  transition: 'all 0.2s'
                }}
              >
                Google Review
